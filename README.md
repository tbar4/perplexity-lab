...
| --- | --- | --- | --- |
| [EchoStar (SATS) Investment Thesis](./apps/sats-pitch/) | app | Interactive long thesis on EchoStar Corporation (NASDAQ: SATS). Dual-layered pitch combining (1) Hughes Network Systems as an indispensable node in the DoD's emerging hybrid space architecture — backed by MDA SHIELD, AFRL STAR-FISH, CASR participation, and DoD private 5G contracts — and (2) the ~2.8% SpaceX stake as a valuation floor. Includes geopolitical demand framing, financial segment analysis, sum-of-parts valuation, catalyst timeline, and risk matrix. | [Open](https://tbar4.github.io/perplexity-lab/apps/sats-pitch/) |
| [Orbital Mechanics & Space Warfare](./apps/orbital-mechanics-warfare/) | app | Four interactive simulations explaining why orbital combat is governed by celestial mechanics, not firepower — Clohessy–Wiltshire relative motion (retrograde paradox), Lagrange point stability, 90-minute LEO line-of-sight windows, and Hohmann transfer vs. direct intercept Δv comparison. | [Open](https://tbar4.github.io/perplexity-lab/apps/orbital-mechanics-warfare/) |
| [Orbital Mechanics & Space Warfare (Narrated)](./apps/orbital-mechanics-warfare-video/) | video | A narrated MP4 explainer covering four reasons orbital mechanics complicates space warfare — relative motion paradoxes, Lagrange point stability, line-of-sight windows over 90-minute orbits, and fuel-optimal intercepts vs. direct pursuit. Companion to the interactive app `orbital-mechanics-warfare`. | [Open](https://tbar4.github.io/perplexity-lab/apps/orbital-mechanics-warfare-video/) |
| [Orbital Warfare Simulator](./apps/orbital-warfare-sim/) | app | Interactive 3D orbital simulator for space warfare scenarios around Earth. RK4 propagator with optional J2 and lunar third-body gravity, Hohmann transfer auto-phasing, Universal-Variables Lambert intercept solver, line-of-sight occlusion via Earth-sphere ray test, and live readouts of range, range-rate, and Δv budget. Four scenarios: LEO->GEO Hohmann chase, Lambert intercept, co-orbital inspection, and cislunar perturbed chase. | [Open](https://tbar4.github.io/perplexity-lab/apps/orbital-warfare-sim/) |
...
| [Rust Channels](./apps/rust-channels/) | app | Interactive reference for message passing in Rust. Compares 7 crates (std, tokio, crossbeam, flume, kanal, async-channel, crossfire) and 19 channel variants across MPSC, MPMC, oneshot, broadcast, watch, and SPSC patterns. Includes an interactive decision flowchart, expandable idiomatic code snippets per channel, relative performance tiers, channel topology diagrams, and a full feature comparison table. Light/dark theme. | [Open](https://tbar4.github.io/perplexity-lab/apps/rust-channels/) |
...
| [Space War Games — Realism vs Playability](./apps/space-war-games-comparison/) | doc | Comparison of 15 space and sci-fi games rated on orbital mechanics fidelity (n-body / patched-conic / on-rails / none), simplifications used, combat tactics realism (delta-v, light-lag, IR signatures, engagement geometry), and performance trade-offs. Includes Children of a Dead Earth, Kerbal Space Program, Flight of Nova, Alliance Space Guard, Nebulous: Fleet Command, Terra Invicta, Reentry, Highfleet, Space Engineers, Star Citizen, Elite Dangerous, Independence War 2, The Expanse: Osiris Reborn, FTL, and Homeworld 3, with a Realism vs Playability scatter chart, per-game scores, and methodology notes. | [Open](https://tbar4.github.io/perplexity-lab/apps/space-war-games-comparison/) |
