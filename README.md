...
| [SDA RL Benchmarks Dashboard](./apps/sda-rl-benchmarks/) | app | Interactive dashboard comparing 16 reinforcement learning benchmarks and environments for Space Domain Awareness and Space Situational Awareness (2016-2026). Filter by dataset type, real vs. simulated data, RSO count, sensor modality, and code availability. Side-by-side comparison view with strengths, limitations, reproducibility notes, action/observation/reward formulations, and direct links to papers and code. Covers narrow-FOV SSA sensor tasking (MIT ARCLab), OrbitZoo (NeurIPS 2025, Starlink-validated), NORAD TLE-based environments (Oakes AMOS 2024), KSPDG, BSK-RL, SPLID/AI-SSA Challenge, EOS-Bench, and more. | [Open](https://tbar4.github.io/perplexity-lab/apps/sda-rl-benchmarks/) |
